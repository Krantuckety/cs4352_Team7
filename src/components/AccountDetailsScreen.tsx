...
export function AccountDetailsScreen({ accountName, accountStatus, onFixNow, onBack }: AccountDetailsScreenProps) {
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        ...
        <Card className="border-2 border-gray-800 p-6">
          <div className="text-center">
            <div className={`w-20 h-20 rounded-full border-2 border-gray-800 ${getStatusColor()} mx-auto mb-4`} />
            <h2 className="mb-2">{accountName}</h2>
            <div className={`inline-block px-4 py-2 border-2 border-gray-800 ${getStatusColor()} text-white text-sm`} >
            ...
            <Card key={issue.id} className="border-2 border-gray-800 p-6">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 border-2 border-gray-800 flex-shrink-0">
                  <div className={`w-full h-full ${getSeverityColor(issue.severity)}`} />
                </div>
          ...
          <div className="space-y-3">
            {accountStatus === 'unsafe' && (
              <>
                <div className="flex items-center gap-3">
                  ...
                  <span>Update password immediately and ensure it's unique</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 border-2 border-gray-800 flex-shrink-0" />
            ...
            {accountStatus === 'needs-work' && (
              <>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 border-2 border-gray-800 flex-shrink-0" />
                  <span>Create a stronger password with at least 12 characters</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 border-2 border-gray-800 flex-shrink-0" />
