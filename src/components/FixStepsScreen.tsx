...
export function FixStepsScreen({
  accountName,
  onMarkAsDone,
  onBack,
            ...
            {steps.map((s, index) => (
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <div
                    className={`w-6 h-6 rounded-full border-2 border-gray-800 flex items-center justify-center ${completedSteps.includes(index + 1) ? "bg-gray-800 text-white" : ""}`}
                  >
          ...
          <Card className="border-2 border-gray-800 p-8 mb-6">
            ...
            <div className="space-y-4">
              {step.instructions.map((instruction, index) => (
                <div
                  key={index}
                  className="flex gap-4 p-4 border-2 border-gray-800"
                >
